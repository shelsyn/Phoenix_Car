  ...
  return (
    <Html lang="en">
      <Head>
        ...
        <meta name="description" content="VentRentAll - ¿Necesitas alquilar un carro en Colombia? En VentRentAll ofrecemos una amplia selección de vehículos a precios asequibles. ¡Reserva hoy mismo y disfruta de la comodidad y libertad de explorar la ciudad a tu propio ritmo!." />
        ...
        <meta name="author" content="VentRentAll" />
        ...
        <title>VentRentAll - renta de carros Colombia</title>
