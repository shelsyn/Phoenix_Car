...
export default function Carrusel(props) {
  ...
  const sliderImages = [
    {
      desktop:
        'https://www.suzukilapaz.com/static/agency-go-virtual/Suzuki/Swift-Booster-Green/2025/prueba-banner.png',
      mobile:
        'https://libertyflagandbanner.com/wp-content/uploads/2015/09/suzuki-pole-banners-1.jpg',
    },
    {
      desktop:
        'https://www.autoland.com.co/wp-content/uploads/2023/07/Banner-desktop.jpg',
      mobile:
        'https://www.suzukiautos.com.co/arquivos/swift-home-banner-mobile.jpg?v=638660982619730000',
    },
